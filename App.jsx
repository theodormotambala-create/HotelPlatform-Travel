...
var NC_DATA = [
  {id:"nc1",icon:"Calendar",color:DS.primary,title:"Réservation confirmée",body:"Grand Hotel Royal a confirme votre reservation.",time:"10 min",read:false,tab:"discover"},
