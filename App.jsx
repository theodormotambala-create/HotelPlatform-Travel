...
function Av(props){
  var sz=props.sz||40;var letter=props.letter||"?";var img=props.img||null;var verified=props.verified||false;var isClient=props.isClient||false;var showLabel=props.showLabel||false;
  var badge=verified?(<div style={{position:"absolute",bottom:-2,right:-2,background:"transparent",borderRadius:"50%",padding:1}}>{isClient?<CBadge sz={Math.round(sz*.38)}/>:<VBadge sz={Math.round(sz*.36)} showLabel={showLabel}/>}</div>):null;
